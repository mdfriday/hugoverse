...
import (
	...
	"expvar"
	"fmt"
	"github.com/mdfriday/hugoverse/pkg/images/vips"
	"github.com/mdfriday/hugoverse/pkg/logger"
	"github.com/mdfriday/hugoverse/pkg/queue"
...
func taskProcessor(cache *Cache, tracer *tracing.Tracer) func(ctx context.Context, data interface{}) (interface{}, error) {
